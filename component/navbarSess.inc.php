    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse">
            <ul  class="nav navbar-nav navbar-right">
                <a class="navbar-brand" href="#" ><i class="material-icons" >account_box</i> <?php echo $_SESSION['name']?> </a>
                <a class="navbar-brand" href="logout.php"><i class="material-icons" >settings_power</i>Log out</a>
                <a class="navbar-brand" ><i class="material-icons" >face</i><?php echo $_SESSION['type']?></a>
            </ul>
        </div>
        </ul><!--navbar-right-->
    </div><!-- /.navbar-collapse -->
